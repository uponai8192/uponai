...
export default function GraceBuilder() {
  ...
  const chip = (active: boolean) =>
    `rounded-full px-3.5 py-1.5 text-xs font-medium transition-all duration-150 ${
      active
        ? 'border border-[#22c55e]/50 bg-[#22c55e]/15 text-[#4ade80]'
        : 'theme-card theme-body hover:border-[#22c55e]/30'
    }`;
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            maxLength={40}
            className="mb-5 w-full rounded-xl border border-[var(--border)] bg-[var(--surface-muted)] px-4 py-2.5 text-sm theme-heading outline-none transition-colors focus:border-[#22c55e]/50"
          />
        ...
        <div className="theme-card flex flex-col rounded-[1.5rem] p-6">
          <div className="mb-4 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-[#22c55e] to-[#54d2ff] text-lg font-bold text-white">G</div>
            <div>
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-[#22c55e] px-4 py-3.5 text-sm font-bold text-white shadow-[0_0_24px_rgba(34,197,94,0.3)] transition-all hover:bg-[#16a34a] active:scale-[0.98]"
          >
