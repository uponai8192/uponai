...
const manualUponAIBlogPosts: UponAIBlogPost[] = [
  {
    ...
    body: [
      'Pro On Call Technologies sells VoIP, networks, cloud management, and data security from its Ohio base in Cincinnati, Columbus, and Dayton, plus Kentucky and Indiana. For years its clients had asked for AI capabilities beyond traditional phone service: pre-routing callers and helping them reach the right location across multiple sites.',
      'Pro On Call reviewed several AI providers before choosing UponAI. It now deploys UponAI as a business AI receptionist for its clients, providing a single answering point, routing callers based on what they say instead of rigid press-1, press-2 menus, and fine-tuning each deployment per customer.',
      'The featured outcome is a multi-location real estate client that now runs one phone number across every location, with calls routing to the correct location exactly as designed and leads and referrals arriving through the AI. A medical billing use case, letting callers pay securely after hours through a secured data dip into the billing portal, has been built and tested, with final changes requested before launch.',
    ],
    category: 'Customer Case Study',
    excerpt:
      'Pro On Call Technologies gave a multi-location real estate client one phone number, speech-based routing to the right office, and a receptionist that sounds personable rather than robotic. Here is how the deployment came together.',
    htmlBody: [
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.26em;text-transform:uppercase;color:var(--brand-cyan-text);margin-bottom:1.5rem">UponAI Customer Story &middot; Telecom &amp; Managed Services</p>',
      '<div style="display:grid;gap:1rem;margin:0 0 2rem;grid-template-columns:repeat(auto-fit,minmax(180px,1fr))">',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Company</p><p style="margin:0.35rem 0 0;font-weight:600">Pro On Call Technologies</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Category</p><p style="margin:0.35rem 0 0;font-weight:600">VoIP, networks, cloud management &amp; data security</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Market</p><p style="margin:0.35rem 0 0;font-weight:600">Ohio based: Cincinnati, Columbus &amp; Dayton, plus Kentucky and Indiana</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Customer since</p><p style="margin:0.35rem 0 0;font-weight:600">Early 2026</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Interviewee</p><p style="margin:0.35rem 0 0;font-weight:600">Robin Koebberling, Project Manager</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Deployment</p><p style="margin:0.35rem 0 0;font-weight:600">Business AI receptionist for clients</p></div>',
      '</div>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">The Challenge</p>',
      '<h3 style="margin-top:0">Clients wanted more than a phone line</h3>',
      '<p>For years, Pro On Call&rsquo;s clients had asked for AI capabilities beyond traditional phone service: pre-routing callers and helping them reach the right location across multiple sites.</p>',
      '<p>One national-footprint client needed to pre-screen where callers came from so they could be routed correctly. Clients also wanted a first interaction that felt personable, not robotic.</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Why UponAI</p>',
      '<h3 style="margin-top:0">A provider that mirrored its own values</h3>',
      '<p>Pro On Call reviewed several AI providers before choosing UponAI. What stood out mirrored its own values: personal service and strong support. The team listened closely, gave specific solutions for each setup, and followed through immediately.</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">The Solution</p>',
      '<h3 style="margin-top:0">One answering point, routing by what callers say</h3>',
      '<p>Pro On Call deploys UponAI as a business AI receptionist for its clients. It provides a single answering point, routes callers based on what they say instead of rigid &ldquo;press 1, press 2&rdquo; menus, and can be fine-tuned to each customer. Administrative and notification functions let Pro On Call monitor how the AI is used.</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Results</p>',
      '<h3 style="margin-top:0">What changed</h3>',
      '<ul>',
      '<li>A real estate client now runs one phone number across multiple locations.</li>',
      '<li>Calls route to the correct locations exactly as designed.</li>',
      '<li>The client is receiving leads and referrals through the AI.</li>',
      '<li>Pro On Call&rsquo;s own receptionist gets callers to the right department faster than traditional menus.</li>',
      '<li>The system supports calls across all of Pro On Call&rsquo;s operating regions.</li>',
      '</ul>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Featured Outcome: Real Estate</p>',
      '<h3 style="margin-top:0">A single, unified front door</h3>',
      '<p>Traditionally, operating in several markets meant a different phone number per area and a fragmented caller experience. Pro On Call&rsquo;s real estate client wanted the opposite: one number and one welcoming, person-like first impression.</p>',
      ...
      '<p style="margin:0 0 1rem;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">The traditional setup</p>',
      '<ol style="list-style:none;margin:0;padding:0">',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">1. A different phone number per area</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">2. Rigid &ldquo;press 1, press 2&rdquo; menus</li>',
      '</ol>',
      '<p style="margin:1rem 0 0;font-weight:600;color:#f87171">&rarr; A fragmented caller experience</p>',
      '</div>',
      '<div style="border:1px solid var(--border);border-radius:1.25rem;padding:1.5rem">',
      '<p style="margin:0 0 1rem;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--brand-green-text)">With UponAI</p>',
      '<ol style="list-style:none;margin:0;padding:0">',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">1. One number across every location</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">2. A personable receptionist answers first</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">3. Speech-based routing finds the right office</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">4. Extensive fine-tuning per client</li>',
      '</ol>',
      '<p style="margin:1rem 0 0;font-weight:600;color:var(--brand-green-text)">&rarr; A cohesive front door generating leads and referrals</p>',
      '</div>',
      '</div>',
      '<blockquote><p style="margin-bottom:0.5rem"><em>&ldquo;Our real estate client is the one I&rsquo;m most proud of. They wanted one singular number, and they wanted that upfront welcome to feel very personable and person-like, not a robot. That was a very big win for us.&rdquo;</em></p><p style="margin-bottom:0;font-size:0.9rem;color:var(--text-subtle)">Robin Koebberling, Project Manager, Pro On Call Technologies</p></blockquote>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">What&rsquo;s Next: Secure AI For Medical Billing</p>',
      '<h3 style="margin-top:0">In progress, not yet launched</h3>',
      '<p>Pro On Call is developing a medical billing use case. It would let callers pay through an AI agent after hours or when live agents are unavailable, with live-agent backup for anyone who prefers not to use AI.</p>',
      '<p>UponAI built an agent capable of a secured data dip into the billing portal so patients can identify themselves and pay securely. Final changes were requested before launch, and testing has left Robin confident in the functionality.</p>',
      '<p style="display:flex;flex-wrap:wrap;gap:0.5rem;margin:1.25rem 0 2rem">',
      '<span style="border:1px solid var(--border);border-radius:999px;padding:0.35rem 0.9rem;font-size:0.8rem;font-weight:600">HIPAA</span>',
      '<span style="border:1px solid var(--border);border-radius:999px;padding:0.35rem 0.9rem;font-size:0.8rem;font-weight:600">PHI</span>',
      '<span style="border:1px solid var(--border);border-radius:999px;padding:0.35rem 0.9rem;font-size:0.8rem;font-weight:600">PII</span>',
      '<span style="border:1px solid var(--border);border-radius:999px;padding:0.35rem 0.9rem;font-size:0.8rem;font-weight:600">Secured data dip</span>',
      '</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Partner Experience</p>',
      '<h3 style="margin-top:0">Responsiveness and specific solutions</h3>',
      '<p>Robin credits UponAI&rsquo;s responsiveness and specific solutions with helping Pro On Call better support its own clients, and recommends UponAI to others in the industry.</p>',
      '<blockquote><p style="margin-bottom:0.5rem"><em>&ldquo;The team has been wonderful to work with. I would highly recommend UponAI.&rdquo;</em></p><p style="margin-bottom:0;font-size:0.9rem;color:var(--text-subtle)">Robin Koebberling, Project Manager, Pro On Call Technologies</p></blockquote>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Key Takeaways For Partners</p>',
      '<div style="border:1px solid var(--border);border-radius:1.25rem;padding:1.5rem;margin:1.5rem 0 2rem">',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">1.</strong> <strong>Extend, do not replace</strong></p>',
      '<p style="margin:0 0 1.25rem">Extend existing phone infrastructure with AI instead of replacing it.</p>',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">2.</strong> <strong>Swap menus for speech</strong></p>',
      '<p style="margin:0 0 1.25rem">Swap rigid menus for intelligent, speech-based routing.</p>',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">3.</strong> <strong>Unify multi-location clients</strong></p>',
      '<p style="margin:0 0 1.25rem">Give multi-location clients one number and a unified presence.</p>',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">4.</strong> <strong>Fine-tune per customer</strong></p>',
      '<p style="margin:0">Support customer-specific workflows with hands-on fine-tuning and responsive support.</p>',
      '</div>',
      '<p style="border-top:1px solid var(--border);padding-top:1.25rem;font-weight:600;color:var(--brand-cyan-text)">UponAI &middot; Customer story: Pro On Call Technologies &middot; Interview with Robin Koebberling, Project Manager</p>',
    ].join(''),
    imageUrl: '/blog-images/pro-on-call-case-study.jpg',
    publishedAt: '2026-09-21T09:00:00.000Z',
    readTimeMinutes: 3.6,
    relatedPages: [
      { label: 'AI Voice For Telecommunications', path: '/voice-ai-for-telecommunication' },
      { label: 'AI Voice For Real Estate', path: '/voice-ai-real-estate' },
      { label: 'Book a Demo', path: 'https://uponai.ai/book-a-democall' },
    ],
    slug: 'pro-on-call-case-study-one-number-every-location',
    title: 'One Number, Every Location: How Pro On Call Unified a Multi-Site Real Estate Client',
    topicSlugs: ['telecom-partnerships', 'ai-voice-operations', 'integration-strategy'],
  },
  {
    author: 'Reecha Chaulagain',
    body: [
      'Advanced Network Services sold and installed NEC and Toshiba phone systems. In 2016 it shifted 100% to VoIP, split the business, and Advanced Hosted Services was created. Today it manages roughly 6,000 endpoints, serving mostly the New York area but active in 16 states.',
      'The problem President Paul Bonelli set out to solve is the oldest one in voice: the call nobody answers. For his customers, after-hours calls were becoming voicemails, routine issues were escalating as emergencies, and callers had no way to get an answer until morning.',
      'After six months of internal use and four to five months with customers, missed calls have been reduced by about 75%. One collectibles customer now takes after-hours calls where the agent checks inventory and sends a link to buy the item on eBay, turning a missed call into a sale at 9pm.',
    ],
    category: 'Customer Case Study',
    excerpt:
      'Advanced Hosted Services runs UponAI’s voice agents on its own phones and resells them to customers across 16 states. Here’s what changed.',
    htmlBody: [
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.26em;text-transform:uppercase;color:var(--brand-cyan-text);margin-bottom:1.5rem">UponAI Customer Story &middot; Hosted Voice</p>',
      '<div style="display:grid;gap:1rem;margin:0 0 2rem;grid-template-columns:repeat(auto-fit,minmax(180px,1fr))">',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Company</p><p style="margin:0.35rem 0 0;font-weight:600">Advanced Hosted Services</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Industry</p><p style="margin:0.35rem 0 0;font-weight:600">Hosted voice / VoIP</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Founded</p><p style="margin:0.35rem 0 0;font-weight:600">2016 (parent 2008)</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Footprint</p><p style="margin:0.35rem 0 0;font-weight:600">NY-area, 16 states</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">Scale</p><p style="margin:0.35rem 0 0;font-weight:600">~6,000 endpoints</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1rem 1.25rem"><p style="margin:0;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--text-subtle)">With UponAI</p><p style="margin:0.35rem 0 0;font-weight:600">~1 yr &middot; 3&ndash;4 clients</p></div>',
      '</div>',
      '<div style="display:grid;gap:1rem;margin:1.5rem 0 2rem;grid-template-columns:repeat(auto-fit,minmax(200px,1fr))">',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1.25rem;text-align:center"><p style="margin:0;font-size:2rem;font-weight:700;color:var(--brand-green-text)">75%</p><p style="margin:0.35rem 0 0;font-size:0.95rem">Fewer missed calls</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1.25rem;text-align:center"><p style="margin:0;font-size:2rem;font-weight:700;color:var(--brand-green-text)">~25%</p><p style="margin:0.35rem 0 0;font-size:0.95rem">Estimated lift in bookings</p></div>',
      '<div style="border:1px solid var(--border);border-radius:1rem;padding:1.25rem;text-align:center"><p style="margin:0;font-size:2rem;font-weight:700;color:var(--brand-green-text)">6,000</p><p style="margin:0.35rem 0 0;font-size:0.95rem">Endpoints under management</p></div>',
      '</div>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">The Setup</p>',
      '<h3 style="margin-top:0">A cabling company that went all-in on VoIP</h3>',
      '<p>Advanced Network Services sold and installed NEC and Toshiba phone systems. In 2016 it shifted 100% to VoIP, split the business, and Advanced Hosted Services was created.</p>',
      '<p>Today it manages roughly 6,000 endpoints, serving mostly the New York area but active in 16 states. President Paul Bonelli has been in the business over 30 years &mdash; starting in the military, then cabling and phone systems, then UCaaS.</p>',
      '<p>The problem he set out to solve is the oldest one in voice: the call nobody answers. For his customers, after-hours calls were becoming voicemails. Routine issues were escalating as emergencies. Callers had no way to get an answer until morning.</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">The Results</p>',
      '<h3 style="margin-top:0">What actually moved &mdash; and why</h3>',
      '<p>Six months of internal use, then four to five months with customers. Most run UponAI as an answering service or after-hours line.</p>',
      '<blockquote><p style="margin-bottom:0.5rem"><em>&ldquo;Missed calls have been reduced by about 75%.&rdquo;</em></p><p style="margin-bottom:0;font-size:0.9rem;color:var(--text-subtle)">Paul Bonelli, President, Advanced Hosted Services</p></blockquote>',
      '<p>The 75% is the headline, but it isn&rsquo;t the mechanism. Paul described a chain of four changes that produce it &mdash; each one removing a reason a call previously went nowhere:</p>',
      '<div style="border:1px solid var(--border);border-radius:1.25rem;padding:1.5rem;margin:1.5rem 0 2rem">',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">1.</strong> <strong>The call gets answered</strong></p>',
      '<p style="margin:0 0 1.25rem">Agents pick up after hours instead of routing to a mailbox &mdash; so the call exists as an interaction, not a message.</p>',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">2.</strong> <strong>The call carries more information</strong></p>',
      '<p style="margin:0 0 1.25rem">&ldquo;The calls that they&rsquo;re getting, they&rsquo;re now getting more information.&rdquo; Transcripts and structured detail replace a 20-second voicemail.</p>',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">3.</strong> <strong>The call gets triaged, not escalated</strong></p>',
      '<p style="margin:0 0 1.25rem">Calls that would typically have become emergency calls aren&rsquo;t &mdash; the agent triages, opens a ticket, and the ticket is addressed the next morning.</p>',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">4.</strong> <strong>The agent is freed for work that needs a human</strong></p>',
      '<p style="margin:0">More customers self-serve. Paul&rsquo;s summary: &ldquo;freeing up agents and giving us better quality of information.&rdquo;</p>',
      '</div>',
      '<p>On bookings: Paul&rsquo;s estimate is ~25%, and he qualified it himself &mdash; &ldquo;bookings is hard to say because we don&rsquo;t have a lot of customers using the calendar features. So if I was to say bookings, let&rsquo;s say bookings could be up about 25% based on the data that I&rsquo;ve seen.&rdquo; Treat it as a directional read from limited calendar adoption, not a verified company-wide result.</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Customer Story</p>',
      '<h3 style="margin-top:0">The collectibles company that sells while it&rsquo;s closed</h3>',
      '<p>One customer shows the difference between preventing a missed call and creating a sale.</p>',
      '<div style="display:grid;gap:1rem;margin:1.5rem 0 2rem;grid-template-columns:repeat(auto-fit,minmax(260px,1fr))">',
      '<div style="border:1px solid var(--border);border-radius:1.25rem;padding:1.5rem">',
      ...
      '<ol style="list-style:none;margin:0;padding:0">',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">1. Customer calls after hours</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">2. Line rings out</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">3. Voicemail, or nothing</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">4. Message handled next day &mdash; if it was left</li>',
      '</ol>',
      '<p style="margin:1rem 0 0;font-weight:600;color:#f87171">&rarr; Missed call</p>',
      '</div>',
      '<div style="border:1px solid var(--border);border-radius:1.25rem;padding:1.5rem">',
      '<p style="margin:0 0 1rem;font-size:0.75rem;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:var(--brand-green-text)">With UponAI</p>',
      '<ol style="list-style:none;margin:0;padding:0">',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">1. AI agent answers after hours</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">2. Caller asks about a specific collectible</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">3. Agent checks inventory for availability</li>',
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">4. Agent sends a link to buy it on eBay</li>',
      '</ol>',
      '<p style="margin:1rem 0 0;font-weight:600;color:var(--brand-green-text)">&rarr; Sale, at 9pm</p>',
      '</div>',
      '</div>',
      '<blockquote><p style="margin-bottom:0.5rem"><em>&ldquo;So now the customer is not only just not missing calls, they&rsquo;re also getting sales after hours by using UponAI.&rdquo;</em></p><p style="margin-bottom:0;font-size:0.9rem;color:var(--text-subtle)">Paul Bonelli, President, Advanced Hosted Services</p></blockquote>',
      '<p>That flips the economics of the pitch. A missed-call fix is cost avoidance, and cost avoidance is always deferrable. An after-hours sales channel is not. The transcript does not quantify those sales &mdash; no volume or revenue figure was provided.</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Implementation</p>',
      '<h3 style="margin-top:0">Easy to integrate, with a real learning curve</h3>',
      '<blockquote><p style="margin-bottom:0.5rem"><em>&ldquo;It was easy to integrate. It&rsquo;s a learning curve, obviously, because you&rsquo;re using AI versus using traditional methods of outcome being exactly what you enter. AI is a little bit different, where it&rsquo;s more generalization. But we&rsquo;ve been happy with the process.&rdquo;</em></p><p style="margin-bottom:0;font-size:0.9rem;color:var(--text-subtle)">Paul Bonelli, President, Advanced Hosted Services</p></blockquote>',
      '<p>For a team that has configured deterministic IVRs for decades, that shift is the real adjustment &mdash; not the integration work. Training landed easier than expected: &ldquo;The training process was not as difficult as I thought it would be. And even while we were going through training sessions, the product was getting better and easier to use.&rdquo;</p>',
      '<p><strong>The features Paul named</strong></p>',
      '<ul>',
      '<li><strong>Knowledge base</strong> &mdash; what lets the agent answer an inventory question instead of taking a message.</li>',
      '<li><strong>Email with call transcripts and links</strong> &mdash; the call documents itself and can carry a purchase link out with it.</li>',
      '<li><strong>Text messaging to on-call people</strong> &mdash; the escalation valve that makes aggressive triage safe.</li>',
      '</ul>',
      '<p>Asked what he still wants: &ldquo;CRM integration is the future&hellip; that&rsquo;s going to be the most important feature that I think anybody releases.&rdquo;</p>',
      '<p style="font-size:0.75rem;font-weight:700;letter-spacing:0.22em;text-transform:uppercase;color:var(--text-subtle);margin-bottom:0.5rem">Why It Matters For VoIP Providers</p>',
      '<h3 style="margin-top:0">Paul&rsquo;s recommendation</h3>',
      '<blockquote><p style="margin-bottom:0.5rem"><em>&ldquo;I absolutely would. UponAI is very powerful. It&rsquo;s got a lot of integrations and it&rsquo;s got a great development team behind it.&rdquo;</em></p><p style="margin-bottom:0;font-size:0.9rem;color:var(--text-subtle)">Paul Bonelli &middot; asked whether he&rsquo;d recommend UponAI to other VoIP providers</p></blockquote>',
      '<p>He was blunt about roadmap speed, which for a reseller is a risk calculation: &ldquo;The development team is actually ahead, which is pretty rare. Usually the end users are ahead of the development team, but in this case the development team seems to be releasing the product faster than we could even ask for it.&rdquo;</p>',
      '<p>The pattern is repeatable. Run it internally first, learn it on your own calls where the stakes are lowest, then take it to customers with real operating experience behind the pitch. Six months in, four or five months out &mdash; and an AI agent attaches to endpoints you already own, in a market where seat pricing keeps compressing.</p>',
      '<p style="border-top:1px solid var(--border);padding-top:1.25rem;font-weight:600;color:var(--brand-cyan-text)">UponAI &middot; Customer story: Advanced Hosted Services &middot; Interview with Paul Bonelli, President &middot; August 12, 2026</p>',
    ].join(''),
    imageUrl: '/blog-images/advanced-hosted-services-case-study.jpg',
    ...
    slug: 'advanced-hosted-services-case-study-after-hours-calls-that-close-business',
    title: 'From Voicemail to eBay Sale: After-Hours Calls That Now Close Business',
