...
const manualUponAIBlogPosts: UponAIBlogPost[] = [
  ...
  },
  {
    ...
    htmlBody: [
      ...
      '<p>Today it manages roughly 6,000 endpoints, serving mostly the New York area but active in 16 states. President Paul Bonelli has been in the business over 30 years, starting in the military, then cabling and phone systems, then UCaaS.</p>',
      ...
      '<h3 style="margin-top:0">What actually moved, and why</h3>',
      ...
      '<p>The 75% is the headline, but it isn&rsquo;t the mechanism. Paul described a chain of four changes that produce it, each one removing a reason a call previously went nowhere:</p>',
      '<div style="border:1px solid var(--border);border-radius:1.25rem;padding:1.5rem;margin:1.5rem 0 2rem">',
      '<p style="margin:0 0 0.35rem"><strong style="color:var(--brand-green-text)">1.</strong> <strong>The call gets answered</strong></p>',
      '<p style="margin:0 0 1.25rem">Agents pick up after hours instead of routing to a mailbox, so the call exists as an interaction, not a message.</p>',
      ...
      '<p style="margin:0 0 1.25rem">Calls that would typically have become emergency calls aren&rsquo;t: the agent triages, opens a ticket, and the ticket is addressed the next morning.</p>',
      ...
      '<li style="list-style:none;margin-left:0;margin-bottom:0.5rem">4. Message handled next day, if it was left</li>',
      '</ol>',
      ...
      '<p>That flips the economics of the pitch. A missed-call fix is cost avoidance, and cost avoidance is always deferrable. An after-hours sales channel is not. The transcript does not quantify those sales; no volume or revenue figure was provided.</p>',
      ...
      '<p>For a team that has configured deterministic IVRs for decades, that shift is the real adjustment, not the integration work. Training landed easier than expected: &ldquo;The training process was not as difficult as I thought it would be. And even while we were going through training sessions, the product was getting better and easier to use.&rdquo;</p>',
      '<p><strong>The features Paul named</strong></p>',
      '<ul>',
      '<li><strong>Knowledge base</strong>: what lets the agent answer an inventory question instead of taking a message.</li>',
      '<li><strong>Email with call transcripts and links</strong>: the call documents itself and can carry a purchase link out with it.</li>',
      '<li><strong>Text messaging to on-call people</strong>: the escalation valve that makes aggressive triage safe.</li>',
      '</ul>',
